		...
		if (isset($_SESSION["usuario_valido"]))
		{
			...
			if($extraido1['rol']==1)
			{
				...
				if (isset($_POST['insertar']) && $error==false)
				{
					...
					<?php
						echo ("<div class='alert alert-success' role='alert' align='center'>[ <A HREF='insertarusuario.php'>Insertar otro Usuario</A> ]</div>");
						}
				else
				{
				?>
				...
				<form CLASS="form" ACTION="insertarusuario.php" METHOD="POST">
					<div class="form-group">
						<div class="row">
							<div class="col-md-4">
								<label>Usuario:</label>
								...
								<input type="text" class="form-control" name="usuario"
									<?PHP
									   if (isset($_POST['insertar']))
										  ...
										  print (">\n");
									   if ($errores["usuario"] != "")
										  print ("<br><SPAN class='alert alert-danger'>" . $errores["usuario"] . "</SPAN><br>");
									?>
							</div>
						</div>
					</div>
								...
								<input type="password" class="form-control" name="clave"
									<?PHP
									   if (isset($_POST['insertar']))
										  ...
										  print (">\n");
									   if ($errores["clave"] != "")
										  print ("<br><SPAN class='alert alert-danger'>" . $errores["clave"] . "</SPAN><br>");
									?>
							</div>
						</div>
					</div>
